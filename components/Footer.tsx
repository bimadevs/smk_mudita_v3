...
export default function Footer() {
    return (
        <footer className="bg-gray-100 dark:bg-[#1a0f0f] text-gray-800 dark:text-white pt-16 pb-8 border-t-4 border-accent-gold transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xl font-bold text-gray-900 dark:text-white">SMK Mudita</span>
                        </div>
                        ...
                        <div className="flex gap-4 mt-2">
                            <a className="text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-white transition-colors" href="#"><span className="material-symbols-outlined">social_leaderboard</span></a>
                            <a className="text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-white transition-colors" href="#"><span className="material-symbols-outlined">photo_camera</span></a>
                            <a className="text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-white transition-colors" href="#"><span className="material-symbols-outlined">smart_display</span></a>
                        </div>
                    </div>
                    {/* Quick Links */}
                    <div>
                    ...
                    {/* Map */}
                    <div className="rounded-lg overflow-hidden h-48 w-full bg-gray-200 dark:bg-gray-800 relative">
                        ...
                        <div className="absolute bottom-2 left-2 bg-white/90 dark:bg-black/80 px-2 py-1 rounded text-xs text-black dark:text-white font-bold pointer-events-none">Lokasi Kami</div>
                    </div>
                </div>
