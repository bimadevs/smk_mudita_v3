...
export default function Profile() {
    return (
        <main className="flex flex-col min-h-screen">
            ...
            <section className="py-16 px-4 md:px-10 bg-gradient-to-b from-gray-100 to-background-light dark:from-gray-900 dark:to-background-dark relative overflow-hidden transition-colors duration-300">
                ...
                <div className="max-w-[960px] mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        ...
                        <div className="shrink-0 relative group">
                            ...
                            <div className="relative size-48 md:size-56 bg-gradient-to-br from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 border-[6px] border-primary rounded-full flex flex-col items-center justify-center shadow-2xl text-center p-4">
                                ...
                                <span className="text-6xl font-black text-gray-900 dark:text-white leading-none my-1">A</span>
            ...
            {/* Vision & Mission */}
            <section className="py-20 px-4 md:px-10 bg-gradient-to-br from-background-light via-background-light to-primary/10 dark:from-background-dark dark:via-background-dark dark:to-primary/10 transition-colors duration-300">
                <div className="max-w-[1080px] mx-auto">
                    <div className="grid md:grid-cols-2 gap-8">
                        {/* Vision Card */}
                        <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 p-10 rounded-2xl shadow-lg border-t-4 border-primary flex flex-col items-start gap-4 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300">
                        ...
                        {/* Mission Card */}
                        <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 p-10 rounded-2xl shadow-lg border-t-4 border-accent-gold flex flex-col items-start gap-4 hover:shadow-xl hover:shadow-accent-gold/10 transition-all duration-300">
                            <div className="p-3 bg-accent-gold/20 rounded-lg text-accent-gold">
                                <span className="material-symbols-outlined text-3xl">flag</span>
                            </div>
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Our Mission</h3>
                            <ul className="text-gray-600 dark:text-gray-300 space-y-3 list-none">
            ...
            {/* History Timeline */}
            <section className="py-16 px-4 md:px-10 bg-gradient-to-b from-background-light to-gray-100 dark:from-background-dark dark:to-gray-900 transition-colors duration-300">
                <div className="max-w-[960px] mx-auto flex flex-col">
                    <h2 className="text-gray-900 dark:text-white text-3xl font-bold leading-tight tracking-[-0.015em] pb-10 text-center">Our Journey</h2>
                    <div className="grid grid-cols-[40px_1fr] gap-x-4 md:gap-x-8 px-4">
                        ...
                        <div className="flex flex-col items-center gap-1 pt-3">
                            ...
                            <div className="w-[2px] bg-gray-300 dark:bg-gray-700 h-full grow my-2"></div>
                        </div>
                        <div className="flex flex-1 flex-col py-3 pb-12">
                            ...
                            <h3 className="text-gray-900 dark:text-white text-xl font-bold leading-normal">Foundation Established</h3>
                        ...
                        <div className="flex flex-col items-center gap-1">
                            <div className="w-[2px] bg-gray-300 dark:bg-gray-700 h-2"></div>
                            <div className="text-primary bg-primary/20 p-2 rounded-full">
                        ...
                        <div className="flex flex-1 flex-col py-3 pb-12">
                            ...
                            <h3 className="text-gray-900 dark:text-white text-xl font-bold leading-normal">First Vocational Class</h3>
                            <p className="text-gray-600 dark:text-gray-400 mt-2">
                        ...
                        <div className="flex flex-1 flex-col py-3 pb-12">
                            ...
                            <h3 className="text-gray-900 dark:text-white text-xl font-bold leading-normal">New Campus Opening</h3>
                            <p className="text-gray-600 dark:text-gray-400 mt-2">
                        ...
                        <div className="flex flex-1 flex-col py-3">
                            ...
                            <h3 className="text-gray-900 dark:text-white text-xl font-bold leading-normal">National Accreditation A</h3>
                            <p className="text-gray-600 dark:text-gray-400 mt-2">
            ...
            <section className="py-20 px-4 md:px-10 bg-gradient-to-br from-primary/5 via-background-light to-background-light dark:from-primary/5 dark:via-background-dark dark:to-background-dark transition-colors duration-300">
                <div className="max-w-[1280px] mx-auto">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Organizational Structure</h2>
                        <p className="text-gray-600 dark:text-gray-400">Meet the dedicated leadership team guiding SMK Mudita towards educational excellence.</p>
                    </div>
            ...
            {/* Facilities Gallery */}
            <section className="py-20 px-4 md:px-10 bg-gradient-to-b from-gray-100 to-background-light dark:from-gray-900 dark:to-background-dark relative transition-colors duration-300">
                ...
                <div className="max-w-[1280px] mx-auto">
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Campus Facilities</h2>
